...
# Part 2: Mining new block

# Creating a Web App
app = Flask(__name__)

# Creating an address for node at Port 5000
...
def mine_block():
    ...
    blockchain.add_transaction(sender = node_address, receiver = 'Vishnu', amount = 1)
...
# Verfiy the chain is valid or not
...
def replace_chain():
    ...
    if is_chain_replaced is True:
        ...
        response['message'] = 'Chain is not replaced'
        response['chain'] = blockchain.chain
    return jsonify(response), 200
